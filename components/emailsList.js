  ...
  return (
    <section className="bg-gray-100">
      <div className="py-1 px-0 mx-auto max-w-screen-xl text-center lg:py-1 ">
        ...
        <div className="flex md:gap-12 bg-blue-100 p-6 hover:bg-blue-200">
          <div>
            <input
              id="default-checkbox"
              type="checkbox"
          ...
          <h1 className="text-gray-900">Job Placement Cell</h1>
          <h1 className="text-gray-900">
            Fwd: Jobs at Recruitzz for Web Development
          </h1>
          <h1 className="text-gray-900">1:02 pm</h1>
        </div>
        <div className="flex md:gap-12  bg-blue-100 p-6">
          <div>
            <input
              id="default-checkbox"
              type="checkbox"
          ...
          <h1 className="text-black">Job Placement Cell</h1>
          <h1 className="text-black">
            Fwd: Jobs at Recruitzz for Web Development
          </h1>
          <h1 className="text-black">1:02 pm</h1>
        </div>
      </div>
    </section>
  );
